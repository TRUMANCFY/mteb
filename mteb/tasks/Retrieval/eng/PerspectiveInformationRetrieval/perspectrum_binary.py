...
class PerspectrumBinaryInformationRetrieval(AbsTaskRetrieval):
    ignore_identical_ids = True

    metadata = TaskMetadata(
        name="PerspectrumBinaryInformationRetrieval",
    ...
    def _load_data_for_split(self):
        ...
        data_dir = os.path.join(root_dir, "data/pir/perspectrum_binary")
